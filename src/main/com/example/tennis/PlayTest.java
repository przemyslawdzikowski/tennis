...
public class PlayTest {
    ...
    private static void simulation() {
        ...
        while (PlayConstants.IN_PLAY.equals(PlayLogic.checkResult(player1, player2))) {
        ...
        if (PlayConstants.WIN_PLAYER_ONE.equals(PlayLogic.checkResult(player1, player2))) {
            System.out.println("player 1 has won");
        }
        if (PlayConstants.WIN_PLAYER_TWO.equals(PlayLogic.checkResult(player1, player2))) {
